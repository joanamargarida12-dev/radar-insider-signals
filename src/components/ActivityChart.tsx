        ...
        <div style={{ padding: '16px 18px', height: 220 }}>
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData}>
              <XAxis dataKey="date" tick={{ fill: '#6b6b80', fontSize: 10, fontFamily: 'monospace' }} axisLine={false} tickLine={false} />
              <YAxis tick={{ fill: '#6b6b80', fontSize: 10, fontFamily: 'monospace' }} axisLine={false} tickLine={false} allowDecimals={false} />
              <Tooltip
                contentStyle={{ background: '#16161f', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 6, fontSize: 12 }}
                labelStyle={{ color: '#6b6b80' }}
              />
              <Line type="monotone" dataKey="buys" stroke="#00d084" strokeWidth={2} dot={{ fill: '#00d084', r: 3 }} name="Buys" />
              <Line type="monotone" dataKey="sells" stroke="#ff4757" strokeWidth={2} strokeDasharray="4 3" dot={{ fill: '#ff4757', r: 3 }} name="Sells" />
              <Legend wrapperStyle={{ fontSize: 11, color: '#6b6b80', fontFamily: 'monospace' }} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      )}
